...
describe("USER | CREATE | POST /api/user", () => {
  let server;
  let school;
  let school2;
  let studentUser;
  ...
  it("verify new user is unique, responds with 400", async () => {
  ...
  it("responds with 201 and creates user - super", async () => {
    const dummyUser = await Dummy(User);
  ...
  it("responds with 201 creates super user - super", async () => {
    const dummyUser = await Dummy(User);
  ...
  it("responds with 201 and creates user - admin", async () => {
    const dummyUser = await Dummy(User);
  ...
  it("responds with 403 and fails to create super user - admin", async () => {
    const dummyUser = await Dummy(User);
  ...
  it("responds with 403 and fails to create user from different school - admin", async () => {
    const dummyUser = await Dummy(User);
  ...
  it("responds with 403 and fails to create user - teacher", async () => {
    const dummyUser = await Dummy(User);
  ...
  it("responds with 403 and fails to create user - student", async () => {
    const dummyUser = await Dummy(User);
